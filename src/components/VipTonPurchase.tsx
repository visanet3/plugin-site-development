...
const VIP_PACKAGES = [
  { days: 30, price_ton: 100, popular: false, label: '1 месяц' },
  { days: 90, price_ton: 270, popular: true, label: '3 месяца', discount: '10%' },
  { days: 180, price_ton: 480, popular: false, label: '6 месяцев', discount: '20%' },
  { days: 365, price_ton: 876, popular: false, label: '1 год', discount: '27%' }
];
