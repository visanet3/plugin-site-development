    ...
    <header className="sticky top-0 z-20 bg-card border-b border-border backdrop-blur-sm bg-opacity-95">
      <div className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center gap-4 flex-1">
          <Button variant="ghost" size="icon" onClick={onToggleSidebar} className="hover:text-orange-500 hover:bg-orange-500/10 transition-colors">
        ...
        <div className="flex items-center gap-3">
          {user ? (
            <>
              <Button variant="ghost" size="icon" className="relative hover:text-orange-500 hover:bg-orange-500/10 transition-colors" onClick={onShowNotifications}>
              ...
              <div className="flex items-center gap-3">
                <Button 
                  variant="ghost" 
                  className="text-left flex items-center gap-3 hover:text-orange-500 hover:bg-orange-500/10 transition-colors"
                ...
                <Button variant="ghost" size="sm" onClick={onLogout} className="hover:text-orange-500 hover:bg-orange-500/10 transition-colors">
                  Выход
                </Button>
              </div>
            </>
